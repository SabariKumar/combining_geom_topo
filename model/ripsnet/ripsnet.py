# PyTorch implementation of RipsNet (de Surrel et. al., PMLR 196:96-106, 2022.)
...
from model.ripsnet.ripsnet_utils import DeepSetLayer, DeepSetSum
...
class RipsNet(nn.Module):
    ...
    def __init__(
        ...
        if use_sigmoid:
            layers += [nn.Sigmoid()]
        self.rips_net = nn.Sequential(*layers)
...
# models defined here can't be subclassed. Use RipsNet base class instead.
# small_RipsNet = partial(
#     RipsNet(
